...
#> $ mean      <dbl> 4.978633, 2.034361, 1.002120
#> $ sd        <dbl> 0.02031865, 0.04537941, 0.02803447
#> $ quantiles <list> [<tbl_df[9 x 2]>], [<tbl_df[9 x 2]>], [<tbl_df[9 x 2]>]
#> $ q.0.025   <dbl> 4.9165642, 1.8542974, 0.8985403
#> $ q.0.5     <dbl> 4.981765, 2.029963, 0.999772
#> $ q.0.975   <dbl> 5.041471, 2.174031, 1.076823
#> $ density   <distfn[]> [mean; Median (IQR) 4.98 [4.97 — 4.99]], [sd1; Median (IQR) …
#> $ ESS       <dbl> 348.9641, 348.9641, 348.9641
```
